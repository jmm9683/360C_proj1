...
public class Matching {
    ...
    /**
     * Matching information representing the index of hospital a resident is matched to, -1 if not
     * matched.
     *
     ...
     * Matching which represents the problem data with no solution, and a resident_matching which
